...
const SUPERADMIN_SECTIONS = [
  ...
  { name: 'NW-010B Output Classification', description: 'Verify and correct output classifications and routing', icon: FileText, page: 'OutputClassificationDebug', color: 'bg-amber-50 text-amber-600' },
];
