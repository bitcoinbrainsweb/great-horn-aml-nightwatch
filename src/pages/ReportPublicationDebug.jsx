...
import { Loader2, Download, RotateCw, ShieldAlert } from 'lucide-react';
...
export default function ReportPublicationDebug() {
  return <AdminGate><ReportPublicationDebugContent /></AdminGate>;
}

function ReportPublicationDebugContent() {
